...
String getToday() {
  ...
  DateFormat formatter = DateFormat('yyyy-MM-dd', 'ko_KR');
                                  ...
                                  child: FutureBuilder<void>(
                                      ...
                                      builder: (context, snapshot) {
                                        return ReorderableListView.builder(
                                            onReorder: (oldIndex, newIndex) => updateCategories(oldIndex, newIndex),
                                    ...
                                    child: Column(
                                      children: [
                                        FutureBuilder<List<defaultTool>>(
                                            future: (selectedCategory == "전체")
                                              ? loadAllDefaultTool()
                                              : (selectedCategory == "기타")
                                                  ? loadEmptyDefaultTool()
                                                  : loadDefaultToolByType(selectedCategory!),
                                            builder: (context, snapshot) {

                                              if (snapshot.connectionState == ConnectionState.waiting) {
                                                return ToolSkeletonList();
                                              } else if (snapshot.hasError) {
                                                return Text('${snapshot.error}');
                                              } else {
                                                List<defaultTool>? defaultTools = snapshot.data;
                                                        ...
                                                        SizedBox(
                                                            ...
                                                            child: ListView.builder(
                                                                    ...
                                                                    itemBuilder: (BuildContext ctx, int idx) {
                                                                      ...
                                                                      String? name;
                                                                      if (defaultTools[idx].name == null || defaultTools[idx].name == "") {
                                                                        name = "";
                                                                      } else {
                                                                        name = defaultTools[idx].name;
                                                                      ...
                                                                      String? toolExplain;
                                                                      if (defaultTools[idx].toolExplain == null || defaultTools[idx].toolExplain == "") {
                                                                        toolExplain = "상세정보를 입력하세요.";
                                                                      } else {
                                                                        toolExplain = defaultTools?[idx].toolExplain;
                                                                      ...
                                                                      String? exp;
                                                                      if (defaultTools[idx].exp == null || defaultTools[idx].exp == "") {
                                                                        exp = "";
                                                                        expWidth = 0;
                                                                        expPadding = 0;
                                                                      } else {
                                                                        exp = defaultTools[idx].exp;
                                                                      ...
                                                                      String? maker;
                                                                      if (defaultTools[idx].maker == null || defaultTools[idx].maker == "") {
                                                                        maker = "Ad.";
                                                                        makerWidth =  40;
                                                                        //makerPadding = 0;
                                                                      } else {
                                                                        maker = defaultTools[idx].maker;
                                                                      ...
                                                                      String? locate;
                                                                      if (defaultTools[idx].locate == null || defaultTools[idx].locate == "") {
                                                                        locate = "";
                                                                        locateWidth = 0;
                                                                        locatePadding = 0;
                                                                      } else {
                                                                        locate = defaultTools[idx].locate;
                                                                      ...
                                                                      if (searchText!.isNotEmpty && !defaultTools[idx].name!.toLowerCase().contains(searchText.toLowerCase())) {
                                                                        return const SizedBox.shrink();
                                                                      } else {
                                                                        return InkWell(
                                                                          onTap:() {
                                                                            showDefault(context, defaultTools[idx]);
                                                                          },
                                                                          child:
                                                                              Column(children: [
                                                                            Padding(
...
//스켈레톤
class ToolSkeletonList extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
...
//커스텀 툴
class CustomToolList extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return FutureBuilder<List<customTool>>(
        future: (selectedCategory == "전체" || selectedCategory == "기타")
            ? loadAllCustomTool()
            : loadEmptyCustomTool(),
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            List<customTool>? customTools = snapshot.data;

            if (customTools != null && customTools.isNotEmpty) {
              return Column(
                children: [
                  Column(
                    mainAxisSize: MainAxisSize.min,
                      ...
                      SizedBox(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (BuildContext ctx, int idx) {
                            ...
                            String? name;
                            if (customTools[idx].name == null || customTools[idx].name == "") {
                              name = "";
                            } else {
                              name = customTools[idx].name;
                            ...
                            String? toolExplain;
                            if (customTools[idx].toolExplain == null || customTools[idx].toolExplain == "") {
                              toolExplain = "상세정보를 입력하세요.";
                            } else {
                              toolExplain = customTools[idx].toolExplain;
                              if (toolExplain!.length > 20) {
                                toolExplain = toolExplain?.substring(0, 20);
                                toolExplain = "$toolExplain...";
                              }
                            ...
                            String? exp;
                            if (customTools[idx].exp == null || customTools[idx].exp == "") {
                              exp = "";
                              expWidth = 0;
                              expPadding = 0;
                            } else {
                              exp = customTools[idx].exp;
                            ...
                            String? locate;
                            if (customTools[idx].locate == null || customTools[idx].locate == "") {
                              locate = "";
                              locateWidth = 0;
                              locatePadding = 0;
                            } else {
                              locate = customTools[idx].locate;
                            ...
                            if (searchText!.isNotEmpty && !customTools[idx].name!.toLowerCase().contains(searchText.toLowerCase())) {
                              return const SizedBox.shrink();
                            } else {
                              return InkWell(
                                onTap: () {
                                  showCustom(context, customTools[idx]);
                                  print(expCheck);
                                  print(todayCheck);
                                },
                                child: Column(
